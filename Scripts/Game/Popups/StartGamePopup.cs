...
#pragma warning disable 649
        ...
        private WalletSaldo walletSaldo;
        //         [SerializeField]
        ...
        {
            walletSaldo = GameObject.Find("HomeScene").GetComponent<WalletSaldo>();
            // base.Awake();
        ...
        {
            int valorApostado = PlayerPrefs.GetInt("apostaAtual");
            walletSaldo.SpendSaldo(valorApostado); ///
